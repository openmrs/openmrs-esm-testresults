 ...
 */
export const addUserDataToCache = (patientUuid, data: PatientData, indicator) => {
 ...
 */
export const getUserDataFromCache = async (patientUuid: string): Promise<PatientData | undefined> => {
 ...
 */
export const loadObsEntries = async (patientUuid: string): Promise<ObsRecord[]> => {
...
export const extractMetaInformation = (concepts: ConceptRecord[]): Record<ConceptUuid, ObsMetaInfo> => {
